local util = {}
local nord = require('mycolor.theme')
...
function util.onColorScheme()
  if vim.g.colors_name ~= "mycolor" then
    vim.cmd [[autocmd! mycolor]]
...
util.contrast = function ()
  vim.cmd [[augroup mycolor]]
  vim.cmd [[  autocmd!]]
  vim.cmd [[  autocmd ColorScheme * lua require("mycolor.util").onColorScheme()]]
