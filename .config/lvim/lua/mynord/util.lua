local util = {}
local nord = require("mynord.theme")
...
function util.onColorScheme()
  if vim.g.colors_name ~= "mynord" then
    vim.cmd([[autocmd! mynord]])
    vim.cmd([[augroup! mynord]])
  end
end
...
util.contrast = function()
  vim.cmd([[augroup mynord]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorScheme * lua require("mynord.util").onColorScheme()]])
